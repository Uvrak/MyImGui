...
)
{
    ...
    PIC_AddEvent(
        Mouse_GridBuilderReleaseClick,
        50.0
    );
}

static void Mouse_GridBuilderSecondClick(
    Bitu
)
{
    Mouse_ButtonPressed(
...
void Mouse_GridBuilderDoubleClick(
    float x,
    float y
)
{
