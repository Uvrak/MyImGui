...
namespace DosBoxX
{
    void Controller::closeExistingInstances()
    {
        HANDLE snapshot =
    ...
    void Controller::setKeyboardLayout(
    ...
    void Controller::clearCommandLine(
        NamedPipeClient& pipeClient
    )
    {
        pipeClient.send(
